...
import com.typany.http.Cache.Entry;
import com.typany.http.CanceledError;
import com.typany.http.Network;
import com.typany.http.NetworkError;
import com.typany.http.NetworkResponse;
import com.typany.http.NoConnectionError;
import com.typany.http.Request;
import com.typany.http.RetryPolicy;
import com.typany.http.ServerError;
import com.typany.http.TimeoutError;
        ...
        while (true) {
            ...
            try {
                ...
                if (httpResponse.getEntity() != null) {
                    responseContents=request.handleRawResponse(httpResponse);
                ...
                if(request.isCanceled()){
                    throw new CanceledError(e.getMessage());
                }
